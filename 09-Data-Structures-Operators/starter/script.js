...
// Nested objects
const {fri: {open: o, close: clo}} = openingHours;
console.log(o, clo);
...
//   if (name === "team1") {
//     console.log(`Odd of victory ${game.team1}: ${num}`);
//   }
//   else if (name === "x") {
//     console.log(`Odd of draw: ${num}`);
//   }
//   else {
//     console.log(`Odd of victory ${game.team2}: ${num}`);
//   }
// }
...
document.querySelector('button').addEventListener('click', function() {
  ...
  for (const [i, row] of rows.entries()) {
    const t = row.trim().toLowerCase().split('_');
    const tSecond = t[1].replace(t[1][0], t[1][0].toUpperCase());
    const tFinal = [t[0], tSecond].join('');
    console.log(`${tFinal.padEnd(20)}${'✅'.repeat(i + 1)}`);;
  }
});
